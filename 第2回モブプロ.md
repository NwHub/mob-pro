...
## PaizaCloud登録（全員）
[https://paiza.cloud/signup](https://paiza.cloud/signup){:target="_blank"}  
...
[https://github.com/settings/keys](https://github.com/settings/keys){:target="_blank"}  
...
## ブランチを作成（1人:ホスト）
[https://github.com/](https://github.com/NwHub){:target="_blank"}
...
# 開発フェーズ
## 完成イメージ
![image](https://user-images.githubusercontent.com/1374058/103772691-45583c80-506d-11eb-819e-8e8996a09d2c.png){:target="_blank"}

## 仕様書（全員）
（[仕様](https://user-images.githubusercontent.com/1374058/103862560-b0078780-5102-11eb-84b7-d144446b9dff.png){:target="_blank"}
／[HTML](https://codepen.io/shiro83/pen/bGwLNKz){:target="_blank"}）
...
## テストコード追加（1人:メンバー）
[Vue Test Utils](https://vue-test-utils.vuejs.org/ja/guides/#%E3%81%AF%E3%81%98%E3%82%81%E3%82%8B){:target="_blank"}
...
## 仕様（全員）
[仕様](https://user-images.githubusercontent.com/1374058/103863189-be09d800-5103-11eb-9ad7-4b4099914d24.png){:target="_blank"}
／[HTML](https://codepen.io/shiro83/pen/WNGMMgr){:target="_blank"}
...
# phase4_Tweet部分（予想時間20分）
  ...
  - [ ] Tweet表示処理を追加
  - [ ] 入力ボックスを追加
  - [ ] CSS適応（[イメージ](https://user-images.githubusercontent.com/1374058/103863627-8bacaa80-5104-11eb-9865-f3fdcd3d6834.png){:target="_blank"}
／[HTML](https://codepen.io/shiro83/pen/OJRvmjq){:target="_blank"}）
  - [ ] テストコード修正
  - [ ] push
...
## Tweet表示
## 仕様（全員）
[仕様](https://user-images.githubusercontent.com/1374058/103863801-cf071900-5104-11eb-904f-9effb57028fd.png){:target="_blank"}
／[HTML](https://codepen.io/shiro83/pen/QWKQrvJ){:target="_blank"}
